...
* Configure dynamic_attributes

 * Non necessary configuration of dynamic attributes for cases where you need to know your dynamic attributes
 * Initializes configured attributes with default value or nil instead

    class DynamicModel < ActiveRecord::Base
      has_dynamic_attributes
      dynamic_attribute :field_test
      dynamic_attribute :field_name, :default => 'Jake'
    end
